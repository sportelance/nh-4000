...
class NH4000Map {
    ...
    initializeDefaultMountains() {
        ...
        const defaultMountains = [
            ...
            { id: 'mt-north-tripyramid', name: 'North Tripyramid', x: 60.12732217184131, y: 58.44987922705314, elevation: 4180 },
            { id: 'mt-cabot', name: 'Cabot', x: 58.23965160653916, y: 35.37342995169082, elevation: 4170 },
            { id: 'mt-east-osceola', name: 'East Osceola', x: 30.53052342006384, y: 50.49214975845411, elevation: 4156 },
            { id: 'mt-middle-tripyramid', name: 'Middle Tripyramid', x: 62.83024073367798, y: 60.45193236714976, elevation: 4140 },
            { id: 'mt-cannon', name: 'Cannon', x: 15.39564440489308, y: 35.85628019323671, elevation: 4100 },
            { id: 'mt-hale', name: 'Hale', x: 33.93631699014041, y: 46.27113526570049, elevation: 4054 },
            { id: 'mt-jackson', name: 'Jackson', x: 62.772939502876895, y: 50.16980676328504, elevation: 4052 },
            { id: 'mt-tom', name: 'Tom', x: 50.345813793070974, y: 25.346376811594205, elevation: 4051 },
            { id: 'mt-moriah', name: 'Moriah', x: 58.29068288508441, y: 30.36123188405798, elevation: 4049 },
            { id: 'mt-passaconaway', name: 'Passaconaway', x: 63.07822108276596, y: 35.43442028985507, elevation: 4043 },
            { id: 'mt-owl-head', name: 'Owl\'s Head', x: 25.71223196881091, y: 50.40893719806763, elevation: 4025 },
            { id: 'mt-galehead', name: 'Galehead', x: 30.754630512472808, y: 42.54975845410629, elevation: 4024 },
            { id: 'mt-whiteface', name: 'Whiteface', x: 67.26262436317579, y: 42.196135265700484, elevation: 4020 },
            { id: 'mt-waumbek', name: 'Waumbek', x: 40.56536129474247, y: 28.68997584541063, elevation: 4006 },
            { id: 'mt-isolation', name: 'Isolation', x: 47.82142995875357, y: 33.824637681159416, elevation: 4004 },
            { id: 'mt-tecumseh', name: 'Tecumseh', x: 35.423046680038794, y: 15.7542270531401, elevation: 4003 }
        ];
